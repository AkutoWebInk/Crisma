...
class SlideMenu(customtkinter.CTkToplevel):
    def __init__(self, master, profile_picture, user_name, **kwargs):
        ...
        self.profile_frame = profile_frame.ProfileFrame(self.bottom_side, 
                                                        username=f"{user_name}", 
                                                        userprofilepicture=f"{self.profile_picture}",
                                                        canvas_color=f"{self.removed_color}")
        self.profile_frame.pack(side="right", anchor="s")
